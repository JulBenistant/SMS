...
%% ****************************** Feedback*************************
    for nb = 1:ntrial
        ...
        % First feedback
        ImgNoKey(window,cfg,[text_ownpayoff_fb1{1}, cfg.social_fb{1,First_Rank}, text_ownpayoff_fb{1}],4,...
        ...
        if data.Calc(size(data.Calc,1),nb) == 1
            ...
            DrawNoKey(window,cfg,text_NoStl{1},4);
            ...
            % Second feedback
            DrawNoKey(window,cfg,[text_ownpayoff_fb2{1}, cfg.social_fb{1,data.Soc(1,nb)}, text_ownpayoff_fb{1}],4);
        end
